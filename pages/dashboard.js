...
import Mastheat from 'components/shared/Masthead';
...
const Dashboard = ({ user, loading }) => {
	...
	const changeBlogStatus = async (blogId, status) => {
		updateBlog(blogId, { status }).then(() => mutate()).catch(() => toast.error('Something went wrong...'));
	};
	...
	return (
		<BaseLayout navClass="transparent" user={user} loading={loading}>
			<Mastheat imagePath={'/images/home-bg.jpg'}>
